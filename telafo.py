...
use_mode = '9' # input("Please select Use Mode:\n'1' -> Sync\n'5' -> Sync & View\n'9' -> Sync & View & Forward: ")
...
my_api_id = "2260209" #config_read_write(file_name , "api_id")
my_api_hash = "4e8a9b32d5380f6d612397402bfa99bb" #config_read_write(file_name , "api_hash")
my_chat_id = "-1001178726847" #config_read_write(file_name , "chat_id")
#################################################
